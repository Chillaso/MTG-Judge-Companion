      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-3">
          {categoryRules.map((rule) => (
            <div key={rule.rule} className="bg-white rounded-lg shadow-sm border border-gray-200">
              <button
                    ...
                    {rule.subrules.map((subrule, index) => (
                      <div key={index} className="border-l-2 border-blue-200 pl-4">
                        ...
                        {subrule.examples && subrule.examples.length > 0 && (
                          <div className="text-sm text-gray-600 italic bg-gray-50 p-3 rounded border-l-2 border-gray-300">
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Rule Categories</h1>
        <p className="text-lg text-gray-600">Browse Magic: The Gathering rules by category</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {CATEGORIES.map((category) => (
          <button
            ...
            className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-left hover:shadow-md hover:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
          >
